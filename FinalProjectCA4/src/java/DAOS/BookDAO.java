...
public class BookDAO extends DAO implements BookDAOInterface {
    ...
    public List<Book> getBookByISBN(String ISBN) {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Exception occured in the finally section of the getBookByISBN() method: " + e.getMessage());
            }
        }
    ...
    // will be changed to use bookGenreDAO
    @Override
    ...
    @Override
    public boolean RemoveTitle(int book_isbn) {
        Connection con = null;
        PreparedStatement ps = null;
        Book remove = null;
        int rowsAffected = 0;
        ...
        if (rowsAffected > 0) {
            ...
            System.out.println("Book was not deleted. Please try again.");
        }
        return true;
    }
