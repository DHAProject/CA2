<%-- 
    ...
    Created on : 3 Dec, 2018, 2:47:24 PM
    Author     : Dhruman
--%>
                ...
                <form class="form-inline my-2 my-lg-0">
                    ...
                    <div class="mx-auto" style="width: 200px;">
                        <%
                            ...
                            if (loginUser != null) {
                        %>
                        <h2>Welcome, <%=loginUser.getUser_fname()%><%=loginUser.getUser_lname()%></h2>
                    ...
                    <a href="DemoServlet?action=logout" class="btn btn-dark  " role="button" aria-pressed="true">Logout</a>
